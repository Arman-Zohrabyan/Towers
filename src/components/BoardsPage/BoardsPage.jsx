    ...
    return (
        <div className="boardsPage">
            <div className="boardsPage-container">
                ...
                <Room createdBy="Valodik" status={0} iAmIn={false} onRoom={1} />
                <Room createdBy="ME" status={1} iAmIn={true} onRoom={2} />
                <Room createdBy="Valodik" status={1} iAmIn={true} onRoom={2} />
                <Room createdBy="Valodik" status={1} iAmIn={false} onRoom={2} />
                <Room createdBy="Valodik" status={0} iAmIn={true} onRoom={1} />
                <Room createdBy="Valodik" status={2} iAmIn={false} onRoom={5} />
            </div>
        </div>
    );
  }
